import puppeteer from "puppeteer-extra"; // drop in replacement for puppeteer, allows plugins
import pluginStealth from 'puppeteer-extra-plugin-stealth'; // go stealth!
...
//   puppeteer.use(pluginStealth());
  ...
  obj.favicon = await getFavicon(page, url);
